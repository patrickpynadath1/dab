    ...
    for prompt in tqdm(prompts):
        ...
        for i in range(repeats):
            ...
            for iter in range(50):
                ...
                old_biases = [model.biases[i].clone().detach() for i in range(len(model.biases))]
                loss, new_output_ids, gpt_logit, senti_losses, one_hot = model.soft_forward(**inputs, labels=inputs.input_ids, use_full_prompt=False)
