...
do
    bash examples/prompt/constrained_sampling_mucola.sh nontoxic $OUTPUTDIR $MODELNAME run_and_evaluate 0.25 dotplusplus l2 0.0 constant legal 0 1 0.0 false 1 0.5 0.05 50 target 1000 1.0 constant 2 50 $EPSILON false false 0.45 0.01 0 true
