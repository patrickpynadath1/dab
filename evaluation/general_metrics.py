...
def conditional_perplexity(loc_to_read, model, tokenizer, device="cuda"):
    perplexities = []
    goodperplexities = []
    total_nll = 0
    total_tokens = 0
...
def load_internal_toxic(
    toxic_model="./checkpoints/BOLT_models/replaced_vocab_roberta_for_jigsaw",
):
